...
local empty_notifbox = require('ui.notification_center.build-notifbox.empty-notifbox')
...
local notifbox_layout = wibox.widget {
    layout = require("ui.widget.overflow").vertical,
    scrollbar_width = 2,
    spacing = 7,
    scroll_speed = 10
}
...
naughty.connect_signal("added", function(n)
	...
	local box = require("ui.notification_center.build-notifbox.notifbox")
